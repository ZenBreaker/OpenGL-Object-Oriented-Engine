...
struct ImGuiWindowSettings
{
    ...
    ImGuiWindowSettings() { Name = NULL; m_ID = 0; Pos = Size = ImVec2ih(0, 0); Collapsed = false; }
};
...
struct ImGuiNavMoveResult
{
    ...
    void Clear()         { m_ID = SelectScopeId = 0; Window = NULL; DistBox = DistCenter = DistAxial = FLT_MAX; RectRel = ImRect(); }
};
...
struct ImGuiTabItem
{
    ...
    ImGuiTabItem()      { m_ID = Flags = 0; LastFrameVisible = LastFrameSelected = -1; NameOffset = -1; Offset = Width = WidthContents = 0.0f; }
};
